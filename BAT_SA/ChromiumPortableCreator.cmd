@echo off
@title Chromium downloader + configer ^| ver.3.0 [15.05.2025]
@cd /d "%~dp0"
@md Chromium
@cd Chromium
...
:: (@echo @cd chrome-win &@echo @start Chrome.exe --user-data-dir=..\Data --disable-gpu-shader-disk-cache --disk-cache-dir=nul --disk-cache-size=1 --no-default-browser-check --test-type --no-sandbox)>"ChromiumLauncher--no-sandbox.bat"
