@echo off
@title Vivaldi downloader + configer ^| ver.6.0 [02.11.2025]
@cd /d "%~dp0"
@echo.
...
@set cr_pref1={"NewTabPage":{"DisabledModules":["dummy","dummy2"],"ModulesVisible":false},"alternate_error_pages":{"backup":false},"autocomplete":{"retention_policy_last_version":108},"autofill":{"credit_card_enabled":false,"enabled":false,"orphan_rows_removed":true,"payment_card_benefits":false,"payment_cvc_storage":false,"profile_enabled":false},"bookmark_bar":{"show_apps_shortcut":false,"show_on_all_tabs":false,"show_only_on_ntp":true},"browser":{"check_default_browser":false,"clear_data":{"browsing_history_basic":true,"cache_basic":true,"cookies_basic":true,"form_data":true,"hosted_apps_data":true,"media_licenses":true,"passwords":true,"preferences_migrated_to_basic":true,"site_settings":true,"time_period":4,"time_period_basic":4},"clear_lso_data_enabled":true,"has_seen_welcome_page":true,"last_clear_browsing_data_tab":1,"window_placement":{"bottom":720,"left":64,"maximized":true,"right":1200,"top":32}},"credentials_enable_autosignin":false,"credentials_enable_service":false,"default_apps_install_state":2,"download":{"directory_upgrade":true,"prompt_for_download":true},"enable_a_ping":false,"enable_do_not_track":true,"first_run_tabs":[],"https_only_mode_enabled":true,"import_bookmarks":false,"import_history":false,"import_home_page":false,"import_search_engine":false,"invalidation":{"per_sender_topics_to_handler":{"1013309121859":{},"8181035976":{}}},"media":{"engagement":{"schema_version":5}},"net":{"network_prediction_options":2},"ntp":{"num_personal_suggestions":0},"omnibox":{"prevent_url_elisions":true},"payments":{"can_make_payment_enabled":false},"plugins":{"plugins_list":[]},"profile":{"avatar_index":3,"block_third_party_cookies":true,"content_settings":{"clear_on_exit_migrated":true,"enable_quiet_permission_ui_enabling_method":{"notifications":1},"exceptions":{},"pref_version":1},"default_content_setting_values":{"background_sync":2,"cookies":1},"exit_type":"Normal","exited_cleanly":true,"local_avatar_index":3,"managed_user_id":"","name":"","password_manager_enabled":false,"were_old_google_logins_removed":true},"safebrowsing":{"enabled":false,"event_timestamps":{}},"search":{"suggest_enabled":false},"settings":{"a11y":{"apply_page_colors_only_on_increased_contrast":true}},"signin":{"allowed":false},"spellcheck":{"dictionaries":["ru"],"dictionary":""},"translate":{"enabled":false},"unified_consent":{"migration_state":10},"vivaldi":{"address_bar":{"extensions":{"hidden_extensions":[],"render_in_dropdown":true,"show_all_toggle":true},"highlight_base_domain":true,"omnibox":{"show_top_sites":false},"search":{"display":1,"show_favicon":true,"suggest_enabled":false},"show_full_url":true,"show_profile":false,"show_qr_generator":true,"visible":false},"appearance":{"css_ui_mods_directory":"CSS","density":false,"range_buttons":true},"bookmarks":{"panel":{"sorting":{"sortField":"manually","sortOrder":1}}},"chained_commands":{"command_list":[],"deleted_command_list":[],"version":1},"dashboard":{"column_limit":4,"enabled":false,"sticky_notes":[],"widgets":[]},"downloads":{"start_automatically":false},"experiments":["css_mods","custom_buttons"],"features":{"calendar":false,"feeds":false,"mail":false},"homepage":"vivaldi://startpage","homepage_cache":"","incognito":{"show_intro":false},"language_at_install":"ru","menu":{"compact":true,"display":0,"icon_type":1},"panels":{"web":{"elements":[],"removed_elements":[{"id":"WEBPANEL_949d4873-deed-4168-b306-92d1848687a5","mobileMode":true,"title":"Social","url":"https://social.vivaldi.net/","zoom":1},{"id":"WEBPANEL_ckmam0bsw00002y5xoafpww5i","mobileMode":true,"origin":"bundle","resizable":false,"title":"Help","url":"https://help.vivaldi.com/","width":-1,"zoom":1},{"id":"WEBPANEL_ckn7fhhqx0000hc2roo8jshm4","mobileMode":true,"origin":"bundle","resizable":false,"title":"Wiki","url":"https://wikipedia.org","width":-1,"zoom":1}]},"window_defaults":{"barVisible":false,"panelVisible":false,"selectedPanel":"PanelDownloads","width":310}},"popups":{"show_in_tab":true},"privacy":{"adverse_ad_block":{},"google_component_extensions":{"hangout_services":false}},"settings":{"in_tab":true,"mono_icons":false},"show_extensions_banner":false,"startpage":{"navigation":2,"speed_dial":{"add_button_visible":false,"display_search":false,"game_button_show":false,"privacy_stats_show":false}},"startup":{"check_is_default":false,"has_seen_feature":1},"status_bar":{"display":2,"minimized":1},"system":{"desktop_theme_color":0,"show_exit_confirmation_dialog":false},"tabs":{"active_min_size":30,"at_edge":true,"cycle_by_recent_order":false,"dim_hibernated":true,"horizontal_scrolling":false,"show_synced_tabs_button":false,"show_trash_can":true,"stacking":{"allow_dnd":true,"dnd_delay":50,"mode":3,"open_accordions":[]},"thumbnails":false,"tooltip":false},"theme":{"dim_blurred":false,"schedule":{"enabled":0,"o_s":{"dark":"Vivaldi2","light":"Vivaldi5"}},"simple_scrollbar":false,"use_animation":false},"themes":{"current":"Vivaldi5"},"toolbars":{"navigation":[],"panel":["PanelBookmarks","PanelReadingList","PanelDownloads","PanelHistory","PanelNotes","PanelTranslate","PanelWindow","PanelSession","PanelMail","PanelCalendar","PanelTasks","PanelFeeds","PanelContacts","PanelWeb","FlexibleSpacer","Settings"],"tabbar_after":["NewTab","FlexibleSpacer","TabButton","Extensions"],"tabbar_before":["PanelToggle","Back","Forward","Reload","AddressField","Spacer","WorkspaceButton"]},"translate":{"enabled":false},"webpages":{"smooth_scrolling":{"enabled":false},"tab_zoom":{"enabled":false}},"welcome":{"read_pages":["welcome_four","import_data","tracker_and_ad","personalize","tabs","touch","welcome_four","import_data","tracker_and_ad","personalize","tabs","touch"],"seen_pages":["welcome_four","import_data","tracker_and_ad","personalize","tabs","touch"]},"windows":{"show_window_close_confirmation_dialog":false},"workspaces":{"button":{"mouse_wheel_enabled":false,"show_in_tabbar":false,"show_name":true},"enabled":false}}}
...
(
@echo #browser, #browser + div, #browser + div + div, #browser button, #browser input, #browser select, #browser textarea, .info , .tab-position .tab { font-family:Arial,Tahoma,'MS Sans Serif',system-ui,sans-serif !important; font-weight:400; font-size:11px; line-height:1.0; text-shadow:transparent 0px 0px 0px, rgba^(0,0,0,0.125^) 0px 0px 0px !important; }
@echo .tabs-top #tabs-tabbar-container .toolbar-tabbar-before .UrlBar-AddressField, .tabs-top #tabs-tabbar-container .toolbar-tabbar-after .UrlBar-AddressField, .tabs-bottom #tabs-tabbar-container .toolbar-tabbar-before .UrlBar-AddressField, .tabs-bottom #tabs-tabbar-container .toolbar-tabbar-after .UrlBar-AddressField { min-width: 25vw !important; max-width: 25vw !important; margin-top: 0 !important; }
...
(@echo @start Vivaldi.exe --disable-gpu-shader-disk-cache --disk-cache-dir=nul --disk-cache-size=1 --disable-background-networking --disable-component-update --no-default-browser-check --show-component-extension-options --disable-breakpad --disable-crash-reporter)>"VivaldiPortable\Vivaldi-bin-win32\VivaldiLauncher.bat"
(@echo @start Vivaldi.exe --disable-gpu-shader-disk-cache --disk-cache-dir=nul --disk-cache-size=1 --disable-background-networking --disable-component-update --no-default-browser-check --show-component-extension-options --disable-breakpad --disable-crash-reporter)>"VivaldiPortable\Vivaldi-bin-win64\VivaldiLauncher.bat"
