@echo off
@title Vivaldi downloader + configer ^| ver.5.0.1.4 [26.10.2025]
@cd /d "%~dp0"
@echo.
...
@echo #tabs-container:not^(.none^).top { padding-left:calc^(30vw + 173px + 35px + 35px^) !important; padding-right:173px !important; padding-top:0px !important; margin-top:0px; min-height:30px; transition:0.3s; }
