...
(@echo ^<?xml version="1.0" encoding="UTF-8"?^> ^<request protocol="3.0" ismachine="1" installsource="ondemand" dedup="cr"^> ^<hw physmemory="4" sse="1" sse2="1" sse3="1" ssse3="1" sse41="1" sse42="1" avx="1"/^> ^<os platform="win" version="10.0" arch="x86"/^> ^<app appid="{%CrChanAppid%}" release_channel="%CrChanName%" ap=""^>^<updatecheck/^>^</app^> ^</request^> )>"in32.xml"
(@echo ^<?xml version="1.0" encoding="UTF-8"?^> ^<request protocol="3.0" ismachine="1" installsource="ondemand" dedup="cr"^> ^<hw physmemory="4" sse="1" sse2="1" sse3="1" ssse3="1" sse41="1" sse42="1" avx="1"/^> ^<os platform="win" version="10.0" arch="x64"/^> ^<app appid="{%CrChanAppid%}" release_channel="%CrChanName%" ap="%CrChanAP64%"^>^<updatecheck/^>^</app^> ^</request^> )>"in64.xml"
