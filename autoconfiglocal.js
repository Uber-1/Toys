...
defaultPref("mousewheel.default.delta_multiplier_y", 150);
defaultPref("mousewheel.min_line_scroll_amount", 50);
...
defaultPref("toolkit.telemetry.shutdownPingSender.enabledFirstSession", true);
