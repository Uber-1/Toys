...
@echo ba92a00f0f55dcae85c1bbd098efe606bd080b3c *vcredist.14.40.33816.0.x64.exe
@echo 467bb2c862def52f2858e5158c96f7ac6d6dcab2 *vcredist.14.40.33816.0.x86.exe
)>vcredist.sha
